export default {
  meta: {
    title: "Southwest National Parks Road Trip — May 2026",
    route: ["zion", "bryce", "grandCanyon"],
    optionalCities: [],
    flexNightDefault: "zion",
    dates: { arrive: "2026-05-09", depart: "2026-05-15", nights: 6 },
    travelers: {
      count: 2,
    ...
    ui: {
      eyebrow:
        'May 9 → May 15, 2026 · <span class="traveler-count-lbl">2</span> travelers · self-booked road trip',
      planTitle: "Southwest National Parks Road Trip",
      planSub:
        "A driving loop out of Las Vegas through Zion, Bryce, and the Grand Canyon's South Rim. Pick a lodge tier per stop; the rental SUV, fuel, and park pass fold into the total. Every figure is a researched 2026 planning estimate.",
