export default {
  meta: {
    ...
    dates: { arrive: "2028-02-06", depart: "2028-02-14", nights: 8 },
    travelers: {
      count: 2,
    ...
    ui: {
      eyebrow:
        'Feb 6 → Feb 14, 2028 · <span class="traveler-count-lbl">2</span> travelers · two-island self-drive',
      planTitle: "Oʻahu &amp; Maui Island-Hop",
      planSub:
        "Honolulu first, then a short inter-island hop to Maui — open-jaw home from Kahului so there's no backtrack. Pick a lodging tier per island; the rental cars, the inter-island flight, and Hawaii's transient accommodations tax fold into the total. Every figure is a researched 2028 planning estimate.",
